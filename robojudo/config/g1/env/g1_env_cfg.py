...
class G1_23Lock(G1_29DoF):
    """23_dof_lock_wrist as g1_29dof_anneal_23dof"""
    _subset: bool = True
...
class G1_23LockCfg(EnvCfg):
    xml: str = (ASSETS_DIR / "robots/g1/g1_23dof_lock_wrist.xml").as_posix()

    dof: DoFConfig = G1_23Lock()
